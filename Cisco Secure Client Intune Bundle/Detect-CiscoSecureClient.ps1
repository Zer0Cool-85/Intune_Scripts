...
$ExpectedPackageRevision = '2026.09.08.2'
...
try {
    ...
    $VersionSummary = ($Modules | ForEach-Object { '{0}={1}' -f $_.Name, $_.ProductVersion }) -join ', '
    Write-Output "Cisco Secure Client bundle $ExpectedPackageRevision detected; $VersionSummary."
    exit 0
}
catch {
    exit 1
