...
The file is a PowerShell data file. The configuration module loads it with
`Import-PowerShellDataFile` when available and otherwise uses PowerShell's safe
syntax-tree evaluator. Keep it limited to literal data values.
